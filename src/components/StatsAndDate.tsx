...
export default function StatsAndDate() {
  ...
  return (
    <div className="p-3 md:p-5 m-12 md:m-0 md:relative md:bottom-10 font-Raleway bg-white rounded-3xl mb-10 gap-2 md:gap-5 md:flex justify-center items-center text-bleu">
